...
export default function Login({resetKey,setProgress}) {
    ...
    return (
        ...
        <ToastContainer
           ...
           />
         <div  >
           <div className={`main-bg w-full h-[90vh] overflow-hidden flex  items-center justify-cente`}>
         ...
         <div className="w-full mb-3 ">
                   <div className="flex items-center">
                     ...
                     <input
                       ...
                       value={password}
                       className={'w-full border rounded px-4 py-2   focus:outline-blue-50 '}
                       />
                   </div>
                 </div>
           ...
           <div className="text-center my-1 -mt-3">
            Or
           </div>
             <button
